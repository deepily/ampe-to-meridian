...
| 2.10 | Terraform module: `vertex/` (Feature Store, initial endpoint config) | DEFERRED | | Terraform applies after GCP auth |
| 2.11 | Vertex AI Experiments integration (pipeline -> experiment logging) | DEFERRED | | Needs GCP credentials for live integration |
...
| 3.6 | Vertex AI TensorBoard integration | DEFERRED | | Needs GCP credentials for live integration |
...
| 3.9 | ML unit tests: gradient flow | DEFERRED | | Applicable to neural nets, not sklearn/XGB trees |
...
| 4.9 | `monitoring/telemetry.py` -- OpenTelemetry integration | DEFERRED | | Needs GCP trace exporter config |
...
| 4.12 | Terraform module: `api/` (Cloud Endpoints, Cloud Armor, GLB) | DEFERRED | | Deploy after Dockerfile built |
| 4.13 | Terraform module: `pubsub/` (topics, subscriptions, CF triggers) | DEFERRED | | Deploy with Cloud Functions |
| 4.14 | Terraform module: `monitoring/` (dashboards, alerting policies) | DEFERRED | | Deploy after live pipeline runs |
| 4.15 | `monitoring/dashboards/retention_pipeline.json` | DEFERRED | | After live monitoring data available |
...
| 5.7 | Cloud Audit Logs verification | DEFERRED | | Requires live GCP pipeline runs |
| 5.8 | VPC Service Controls: dry-run -> enforced | DEFERRED | | Requires org-level perms |
| 5.9 | `docs/architecture.md` -- system design with Mermaid diagrams | DEFERRED | | Polish pass |
| 5.10 | `docs/runbook.md` -- operational documentation | DEFERRED | | Polish pass |
...
|---|-----------|----------|----------|--------|
| 27 | **AI Lifecycle Management** | CRITICAL | 2, 3 | NOT STARTED |
| 16 | **AI-Specific Security** | CRITICAL | 2, 3 | NOT STARTED |
| 20 | **Failure & Recovery Testing** | CRITICAL | 2, 3, 5 | NOT STARTED |
| 19 | Observability | MODERATE | 2, 4 | NOT STARTED |
| 15 | Data Protection & Privacy | MODERATE | 1 | NOT STARTED |
| 17 | Compliance & Governance | MODERATE | 1, 5 | NOT STARTED |
| 14 | Infrastructure & Network Security | MODERATE | 1, 4 | NOT STARTED |
| 18 | Availability Design | MODERATE | 4 | NOT STARTED |
| 21 | Graceful Degradation | MODERATE | 4 | NOT STARTED |
| 23 | Resource Efficiency | MODERATE | 1 | NOT STARTED |
| 30 | Configuration Management | MODERATE | 1, 3 | NOT STARTED |
| 31 | API Design & Versioning | MODERATE | 4 | NOT STARTED |
| 32 | Extensibility | MODERATE | 2, 4 | NOT STARTED |
| 13 | Authentication & Authorization | MODERATE | 4 | NOT STARTED |
| 11 | API Documentation | MODERATE | 4 | NOT STARTED |
